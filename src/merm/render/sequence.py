...
def _build_defs(svg: ET.Element, theme: Theme) -> None:
    ...
    m3.set("id", "seq-cross")
    m3.set("markerWidth", "6")
    m3.set("markerHeight", "6")
    m3.set("refX", "3")
    m3.set("refY", "3")
    m3.set("orient", "auto")
    ...
    m4.set("id", "seq-async")
    m4.set("markerWidth", "6")
    m4.set("markerHeight", "4")
    m4.set("refX", "6")
    m4.set("refY", "2")
    m4.set("orient", "auto")
    m4.set("markerUnits", "userSpaceOnUse")
    pl2 = ET.SubElement(m4, "polyline")
    pl2.set("points", "0 0, 6 2, 0 4")
    pl2.set("fill", "none")
