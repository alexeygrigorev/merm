...
from merm.ir.sequence import MessageType, SequenceDiagram
...
def _build_defs(svg: ET.Element, theme: Theme) -> None:
    ...
    m3.set("id", "seq-cross")
    m3.set("viewBox", "0 0 10 10")
    m3.set("markerWidth", "8")
    m3.set("markerHeight", "8")
    m3.set("refX", "5")
    m3.set("refY", "5")
    m3.set("orient", "auto")
    ...
    l2.set("stroke-width", "1.5")

    # Async (open arrow, one-sided).
    m4 = ET.SubElement(defs, "marker")
    m4.set("id", "seq-async")
    m4.set("viewBox", "0 0 10 10")
    m4.set("markerWidth", "8")
    m4.set("markerHeight", "8")
    m4.set("refX", "10")
    m4.set("refY", "5")
    m4.set("orient", "auto")
    m4.set("markerUnits", "userSpaceOnUse")
    pl2 = ET.SubElement(m4, "polyline")
    pl2.set("points", "0 0, 10 5, 0 10")
    pl2.set("fill", "none")
...
def _build_css(theme: Theme) -> str:
    ...
    return (
        ...
        f"stroke: {theme.edge_stroke}; stroke-width: 1; }}\n"
